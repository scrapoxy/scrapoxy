...
@Component({
    selector: `connector-${CONNECTOR_DECODO_TYPE}`,
    templateUrl: 'connector.component.html',
})
export class ConnectorDecodoComponent implements IConnectorComponent, OnInit {
    @Input()
    form: FormGroup;
    ...
    private credentialType: EDecodoCredentialType | undefined;
    ...
    get hasSessionDuration(): boolean {
        return this.credentialType === EDecodoCredentialType.RESIDENTIAL;
    }
