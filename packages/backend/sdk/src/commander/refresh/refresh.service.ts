    ...
    async createAndRemoveConnectorProxies(
        ...
        for (const remoteProxy of proxies.created) {
            ...
            const localProxy: IProxySync = {
                ...
                transportType: remoteProxy.transportType,
                key: remoteProxy.key,
                ...
                removing: false,
                removingForce: false,
                removingForceCap: remoteProxy.removingForceCap,
            ...
            if (remoteProxy) {
                if (
                    ...
                    const proxyUpdated: IProxyData = {
                        ...
                        transportType: localProxy.transportType,
                        key: localProxy.key,
                        ...
                        removingForceCap: localProxy.removingForceCap,
