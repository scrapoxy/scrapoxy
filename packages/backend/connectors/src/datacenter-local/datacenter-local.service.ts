...
import { convertDatacenterLocalRegion } from './datacenter-local.helpers';
import { TRANSPORT_DATACENTER_LOCAL_TYPE } from './transport';
import type {
...
function convertToProxy(instance: IInstanceDatacenterLocalView): IConnectorProxyRefreshed {
    ...
    const proxy: IConnectorProxyRefreshed = {
        ...
        countryLike: convertDatacenterLocalRegion(instance.region),
    };
